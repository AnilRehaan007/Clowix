...
public class Shared extends Fragment implements Listener.CallBackFromListener {
    ...
    public Shared(SearchView searchView,int network_status,String user_profile_locker) {
    ...
    private  void read_time_access()
    {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if(cloud_data_information.getShared_status().equals(Shared_Status.YES.toString()))
